...
2. Parse plan for file paths and read those files
3. Find relevant documentation (CLAUDE.md, docs folder)
4. Include conversation context (see below)
5. Compile context JSON to temp file
6. **Calculate and display cost estimate, wait for user confirmation** (see Cost Estimation section)
7. If user confirms, run review script:
