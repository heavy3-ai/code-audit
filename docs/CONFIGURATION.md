...
| `max_total_context` | Token limit for reviews | `200000` |
| `enable_web_search` | Enable web search for reviews | `false` |

---

## Web Search (Optional)

Enable live web search by setting `"enable_web_search": true`. This adds the `:online` suffix and search plugins to API calls, allowing models to reference up-to-date documentation, CVEs, and best practices.
